...
public class SparqlUpdateApiController extends VitroApiServlet {
	...
	private UpdateRequest parseUpdateString(HttpServletRequest req)
		...
		try {
			// WheatVIVO mod: Parse the update string using ARQ
			// Syntax as a workaround for a Jena bug that causes
			// a StackOverflowException when an insert is larger
			// than around 5000 triples.
			// See https://mail-archives.apache.org/mod_mbox/jena-users/201601.mbox/%3C568BA9FB.5090709@apache.org%3E
