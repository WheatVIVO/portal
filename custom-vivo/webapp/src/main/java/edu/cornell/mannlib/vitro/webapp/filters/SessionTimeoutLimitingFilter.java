...
public class SessionTimeoutLimitingFilter implements Filter {
	...
	// WheatVIVO : increase session lifetime to 9 hours to avoid reappearing cookie consent popup
	private static final int TRIVIAL_SESSION_LIFETIME = 9 * 60; // seconds
