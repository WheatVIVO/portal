    ...
    function getResearcherCount(area) {
        ...
        if ( area == "global" ) {
            if ( geoResearcherCount == 1 ) {
                researcherText = " " + i18nStrings.researcherOrOrganization + " " + i18nStrings.withKnownLocations + " " + i18nStrings.inString;
            }
            else {
                researcherText = " " + i18nStrings.researchersOrOrganizations + " " + i18nStrings.withKnownLocations + " " + i18nStrings.inString;
            }
